...
var backend_base_url = "https://athenahack-379019.wl.r.appspot.com/"
//var backend_base_url = "http://127.0.0.1:5000/"
...
async function after_login(){
    ...
    console.log("response old:",backend_new_user_response)

    inner_text = ""
    for(let i = 0;i < backend_login_response.length; i++){
...
async function old_user_login(){
    ...
    backend_login_response = await request_func(backend_url)
    console.log(backend_login_response)
...
async function new_user_submit(){
    ...
    // backend_url += "&phone_number=" + phone
    // backend_url += "&linkedin_url=" + linkedin
    ...
    for(let i = 0;i < backend_new_user_response.length; i++){
        inner_text += "<div class=similar_style><p>Get Connected With " + backend_new_user_response[i].fullname + "</p>"
        inner_text += "<p>Email: " + backend_new_user_response[i].email + "</p></div>"
        // inner_text += "<p>Phone Number: " + backend_new_user_response[i].phone_number +"</p>"
        // innter_text += "<p>LinkedIn: " + backend_new_user_response[i].linkedin_url + "</p></div>"

 
    }

    document.getElementById("similar_person").innerHTML = inner_text
    console.log("result:",document.getElementById("similar_person"))
